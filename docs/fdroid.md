...
1. Ensure this branch is merged and the release build succeeds from a clean checkout.
2. Confirm that the tagged release referenced by the YAML is still the intended first F-Droid version.
